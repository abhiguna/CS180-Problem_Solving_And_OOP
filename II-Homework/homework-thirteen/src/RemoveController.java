...
public final class RemoveController {
    ...
    private void getRemoveButtonSemantics() {
        ...
        Optional<Product> sku = inventoryModel.searchBySku(removeView.getSkuTextField().getText());
        ...
        if (!skuExists) {
            ...
            product = sku.get();
            JOptionPane.showMessageDialog(null, "This product has been removed from the inventory.", "Product Inventory", JOptionPane.INFORMATION_MESSAGE);
            inventoryModel.remove(product);
        }
    ...
    private void getClearButtonSemantics() {
        //TODO implement method
        JButton clearButton = removeView.getClearButton();
